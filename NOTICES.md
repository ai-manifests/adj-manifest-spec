...
The Agent Deliberation Journal (ADJ) was originated by **David H. Friedel Jr.** of **MarketAlly** in 2026 as part of the ai-manifests protocol family ([adj-manifest.dev](https://adj-manifest.dev)). The specification text is released under the [Community Specification License 1.0](LICENSE.md) (Patent and Copyright). The companion specifications — [ADP](https://github.com/ai-manifests/adp-manifest-spec) (deliberation protocol) and [ACB](https://github.com/ai-manifests/acb-manifest-spec) (cognitive budget) — share the same origin and licensing model.

"ADP", "ADJ", "ACB", and "Agent Registry" are trademarks of MarketAlly. The specifications are openly licensed; the names are not.
...
This section includes any Exclusion Notices made against a Draft Deliverable or Approved Deliverable as set forth in the Community Specification License.
